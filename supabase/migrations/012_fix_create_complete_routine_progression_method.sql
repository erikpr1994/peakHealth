-- Migration: Fix create_complete_routine function to properly cast progression_method to enum type
-- The issue was trying to insert text into a progression_method enum column
