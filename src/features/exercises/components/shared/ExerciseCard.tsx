...
export function ExerciseCard({
  ...
  return (
    <Card
      className={`cursor-pointer hover:shadow-md transition-shadow ${sizeClasses[size]} mx-auto ${
        isSelected ? "border-primary shadow-lg ring-1 ring-primary/20" : "border-gray-200 hover:border-gray-300"
      } ${className}`}
      onClick={onClick}
    >
      {/* Exercise Image/Icon */}
