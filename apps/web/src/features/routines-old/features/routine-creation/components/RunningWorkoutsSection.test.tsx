...
import { RunningWorkout } from '@/features/routines-old/types';

// Mock the WorkoutSection component
vi.mock(
  '@/features/routines-old/features/workout-management/components/WorkoutSection',
  () => ({
    default: ({
      section,
    }: {
...
vi.mock(
  '@/features/routines-old/features/workout-management/components/WorkoutHeader',
  () => ({
    default: ({
      workout,
    }: {
...
vi.mock(
  '@/features/routines-old/features/workout-management/components/WorkoutDetails',
  () => ({
...
vi.mock(
  '@/features/routines-old/features/trail-running/TrailRunningWorkout',
  () => ({
    default: (): React.ReactElement => (
...
vi.mock('@/features/routines-old/utils/workoutCalculations', () => ({
