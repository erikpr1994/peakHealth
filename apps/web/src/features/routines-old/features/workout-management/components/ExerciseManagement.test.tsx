...
import type { Exercise } from '@/features/routines-old/types';
import type { WorkoutSet } from '@/features/routines-old/components/SetManagement';

// Mock the SetManagement component
vi.mock('@/features/routines-old/components/SetManagement', () => ({
  default: ({
    sets,
    onSetsChange,
  }: {
