  ...
  'Q1 2025': [
    {
      ...
      description:
        'Enhanced revenue analytics with predictive insights and trainer performance metrics',
    ...
    },
    {
      ...
      description:
        'Native mobile application for trainers to manage clients on-the-go',
      status: 'planning',
      priority: 'high',
      progress: 20,
      team: 'Mobile Team',
  ...
  'Q2 2025': [
    {
      ...
      description:
        'Machine learning-powered workout suggestions based on user preferences and goals',
      status: 'planning',
      priority: 'medium',
      progress: 10,
      team: 'AI Team',
    ...
    },
    {
      ...
      description:
        'Dedicated dashboard for corporate clients to manage employee wellness programs',
      status: 'planning',
      priority: 'high',
      progress: 5,
  ...
  'Q3 2025': [
    {
      ...
      description:
        'Integration with popular fitness wearables for automatic workout tracking',
      status: 'research',
      priority: 'medium',
      progress: 0,
...
const recentlyCompleted = [
  {
    ...
    description:
      'Comprehensive trainer management with service pricing and credentials',
    ...
    <div className="p-6 space-y-6">
      ...
      <div>
        <p className="text-muted-foreground">
          Track upcoming features, development progress, and product milestones
          across Peak Health platform.
        </p>
      </div>
                          ...
                          <div className="flex items-center gap-3">
                            ...
                            <div className="flex-1">
                              ...
                              <div className="flex items-center gap-2 mt-1">
                                ...
                                <Badge
                                  variant={getStatusColor(feature.status)}
                                  className="text-xs"
                                >
