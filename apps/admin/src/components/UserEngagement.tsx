      ...
      <div className="flex items-center justify-between">
        <div>
          <p className="text-muted-foreground">
            Monitor user engagement patterns, retention rates, and feature
            adoption across the Peak Health platform.
          </p>
        </div>
          ...
          <CardContent className="p-4">
            <div className="space-y-2">
              ...
              <p className="text-2xl font-semibold">
                {engagementMetrics.overview.dailyActiveUsers.value.toLocaleString()}
              </p>
              <div className="text-xs">
                {formatChange(
                  engagementMetrics.overview.dailyActiveUsers.change
                )}
        ...
        <Card>
          <CardContent className="p-4">
            <div className="space-y-2">
              ...
              <p className="text-2xl font-semibold">
                {engagementMetrics.overview.weeklyActiveUsers.value.toLocaleString()}
              </p>
              <div className="text-xs">
                {formatChange(
                  engagementMetrics.overview.weeklyActiveUsers.change
                )}
                <span className="text-muted-foreground ml-1">
                  vs last period
                </span>
        ...
        <Card>
          <CardContent className="p-4">
            <div className="space-y-2">
              ...
              <p className="text-2xl font-semibold">
                {engagementMetrics.overview.monthlyActiveUsers.value.toLocaleString()}
              </p>
              <div className="text-xs">
                {formatChange(
                  engagementMetrics.overview.monthlyActiveUsers.change
                )}
                <span className="text-muted-foreground ml-1">
                  vs last period
                </span>
        ...
        <Card>
          <CardContent className="p-4">
            <div className="space-y-2">
              ...
              <p className="text-2xl font-semibold">
                {engagementMetrics.overview.sessionDuration.value}
              </p>
              <div className="text-xs">
                {formatChange(
                  engagementMetrics.overview.sessionDuration.change
                )}
                <span className="text-muted-foreground ml-1">
                  vs last period
                </span>
        ...
        <Card>
          <CardContent className="p-4">
            <div className="space-y-2">
              ...
              <p className="text-2xl font-semibold">
                {engagementMetrics.overview.retention7Day.value}%
              </p>
              <div className="text-xs">
        ...
        <Card>
          <CardContent className="p-4">
            <div className="space-y-2">
              ...
              <p className="text-2xl font-semibold">
                {engagementMetrics.overview.retention30Day.value}%
              </p>
              <div className="text-xs">
                  ...
                  <div key={segment.name} className="space-y-3">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-3">
                        <div
                          className={`w-4 h-4 rounded ${getSegmentColor(segment.color)}`}
                        />
                        <div>
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-muted-foreground">
                            {feature.sessions.toLocaleString()} sessions • Avg:{' '}
                            {feature.avgTime}
                          </p>
                        </div>
                      </div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-center py-12">
                ...
                <p className="text-sm text-muted-foreground">
                  Advanced cohort retention analysis and user lifecycle
                  tracking.
                </p>
              </div>
            </CardContent>
