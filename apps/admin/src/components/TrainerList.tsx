...
export function TrainerList({ scopeInfo, onViewTrainer }: TrainerListProps) {
  ...
  const totalClients = trainers.reduce((sum, trainer) => sum + trainer.clients, 0);
      ...
      <div className="flex items-center justify-between">
        <div>
          <p className="text-muted-foreground">
            Manage trainer profiles, monitor performance, and oversee service offerings across your platform.
          </p>
        </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    <Badge variant={getStatusColor(trainer.status)} className="text-xs">
                      {trainer.status}
                    </Badge>
                  </div>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4 text-sm">
                ...
                <div>
                  ...
                  <p className="font-medium">{formatCurrency(trainer.monthlyRevenue)}</p>
                </div>
              </div>
              ...
              <div className="pt-2 border-t">
                <div className="flex items-center justify-between text-xs text-muted-foreground mb-3">
                  ...
                  <span>Last active: {new Date(trainer.lastActive).toLocaleDateString()}</span>
                </div>
                <Button 
                  variant="outline" 
                  className="w-full"
